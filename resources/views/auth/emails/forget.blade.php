...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="https://beyahfitness.com" style="mso-line-height-rule: exactly;
 ...
 organize, share and use all your visual assets in one place - all on your desktop." height="32" src="https://beyahfitness.com/wp-content/uploads/2019/03/BeYAH_Fitness_Loog.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 107px; margin: 0px;" width="107" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://beyahfitness.com" style="mso-line-height-rule:
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Not to worry, we got you! Your new password is below.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
